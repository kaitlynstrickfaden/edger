...
This function comes with a progress bar, courtesy of the `progress` package. The progress bar tells the user which image the function is currently recoloring, how many total images it has to recolor, a percent completion, and an elapsed time. It doesn't display on the vignette, but it will display in the console of the user's R session.
